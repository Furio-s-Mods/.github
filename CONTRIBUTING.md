...
Alternatively, you can define a system-wide environment variable named `VINTAGE\_STORY` containing the absolute path to your Vintage Story installation directory. The build engine will automatically pick it up if no `.user` file is present.
